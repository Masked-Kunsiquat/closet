...
/**
 * Compute the number of distinct outfit logs that include the specified clothing item.
 *
 * @param clothingItemId - The clothing item id to count wears for
 * @returns The count of distinct outfit logs that include the item
 */
