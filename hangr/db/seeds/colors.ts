 ...
 *
 * Explicit `null` hex values are stored as SQL NULL; all other values are passed through as-is.
 * All inserts are executed inside a single transaction; if any insert fails the transaction will be rolled back.
 */
